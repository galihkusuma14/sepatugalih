		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a class="logo pull-left"><form action="pencarian_index.php" method="GET">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="caption">
				...
				<a class="btn btn-info" href="login.php">Beli <i class="fa fa-shopping-cart"></i></a>
				<a class="btn btn-default" href="login.php">Detail</a>
			</div>
			</div>
		</div>
	<?php endforeach ?>
