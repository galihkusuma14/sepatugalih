				...
				<div class="span11">
					<div class="account pull-right">
						<ul class="user-menu">
							...
							<li class="dropdown mega-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">New Balance <i class="fa fa-caret-down"></i></a>
				...
				<!-- /ASIDE -->
					...
					<div id="store">
						...
						<div class="row">
							 ...
							 <?php $ambil = $koneksi->query("SELECT * FROM barang WHERE kategori LIKE 'nb%'"); ?>
