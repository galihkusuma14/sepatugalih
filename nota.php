...
<body>		
			...
			<div class="row">
				...
				<div class="span11">
					<div class="account pull-right">
						...
						<li class="dropdown mega-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Nota <i class="fa fa-caret-down"></i></a>
							<div class="custom-menu">
								<div class="row">
									<div class="col-md-2">
										<ul class="list-links">
	...
	<section class="konten">
		...
		<?php 
	$ambil = $koneksi->query("SELECT * FROM transaksi JOIN user ON transaksi.id_user=user.id_user WHERE transaksi.id_transaksi='$_GET[id]'");
	$detail = $ambil->fetch_assoc();
		...
		<div class="row">
			...
			<div class="col-md-4">
				<h3>Transaksi</h3>
				<strong>No Pembelian: <?php echo $detail['id_transaksi']; ?></strong><br>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php $nomor=1; ?>
				<?php $ambil=$koneksi->query("SELECT * FROM pembelian WHERE id_transaksi='$_GET[id]'") ?>
		...
		<div class="row">
			<div class="col-md-7">
				<div class="alert alert-info">
					<p>
						Silahkan Melakukan Pembayaran Rp. <?php echo number_format($detail['total_transaksi']); ?> ke <br>
						<strong>BANK BCA 5910035426 a/n Galih Kusuma Dinata</strong>
					</p>
				</div>
